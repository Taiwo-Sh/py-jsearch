...
class TestJobSearchParams:
    ...
    def test_work_from_home_mapping(self):
    ...
    def test_country_and_language(self):
...
class TestJobDetailsParams:
    ...
    def test_extended_publisher_details(self):
    ...
    def test_years_of_experience_validation(self):
        ...
        for exp in valid_values:
            params = JobSalarySearchParams(
                job_title="Engineer",
                location="California",
                years_of_experience=exp,  # type: ignore
            )
...
class TestApplyOption:
    ...
    def test_optional_is_direct(self):
...
class TestJob:
    ...
    def test_job_with_all_fields(self, sample_job_data):
    ...
    def test_apply_options_parsing(self, sample_job_data):
...
class TestJobSalaryInfo:
    ...
    def test_all_fields(self, sample_salary_data):
    ...
    def test_optional_base_salary_fields(self, sample_salary_data):
        """Test optional base salary breakdown fields."""
        salary = JobSalaryInfo(**sample_salary_data)
        assert salary.min_base_salary == 95000.0
        assert salary.max_base_salary == 170000.0
        assert salary.median_base_salary == 130000.0
...
class TestCompanySalaryInfo:
    ...
    def test_all_fields(self, sample_company_salary_data):
        """Test CompanySalaryInfo with all fields."""
        salary = CompanySalaryInfo(**sample_company_salary_data)
        assert salary.company == "Google"
        assert salary.job_title == "Software Engineer"
        assert salary.location == "Mountain View, CA"
        assert salary.min_salary == 150000.0
...
class TestParameterValidation:
    ...
    def test_invalid_date_posted(self):
        ...
        with pytest.raises(ValidationError):
            JobSearchParams(query="test", date_posted="invalid")
